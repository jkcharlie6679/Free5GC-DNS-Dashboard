$(document).ready(function () {
  ...
  $('#searchBtn').click(function () {
    ...
    pageHistory(
      `http://${apiEndpoint}/api/history?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00${urlParameter}`
    );
  });
  ...
  function initial() {
    ...
    $('#endTime').val(endTime);
    pageHistory(`http://${apiEndpoint}/api/history?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00`);
    getDeviceId();
  }

  function getDeviceId() {
    $.get(`http://${apiEndpoint}/api/deviceId`, function (data) {
