$(document).ready(function () {
  ...
  $("#callFlowBtn").click(function () {
    ...
    $("#endTime").val(endTime);
    callFlowPage(`http://140.118.121.110/api/callFlowLog?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00`);
  });
  ...
  $("#systemLogBtn").click(function () {
    ...
    $("#startTime").val(startTime);
    $("#endTime").val(endTime);
    systemLogpage(`http://140.118.121.110/api/systemLog?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00`);
  });
