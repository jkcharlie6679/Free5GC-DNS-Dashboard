$(document).ready(function () {
    ...
    $("#callFlowBtn").click(function () {
        ...
        $("#endTime").val(endTime);
        callFlowPage(
            `http://140.118.121.110:5534/call_flow_log?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00`
        );
    });
    ...
    $("#systemLogBtn").click(function () {
        ...
        $("#endTime").val(endTime);
        systemLogpage(
            `http://140.118.121.110:5534/system_log?startTime=${startTime}%2B08:00&endTime=${endTime}%2B08:00`
        );
    });
